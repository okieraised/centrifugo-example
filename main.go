...
const (
	CentrifugoURL = "ws://localhost:8008/connection/websocket"
	APIKey        = "1234567890"
	Token         = "123456aA@"
	Channel       = "cc1"
)
...
func main() {
	...
	client := centrifuge.NewJsonClient(
		"ws://localhost:8008/connection/websocket",
		centrifuge.Config{
	...
	sub, err := client.NewSubscription("cc1", centrifuge.SubscriptionConfig{
		Recoverable: true,
		JoinLeave:   true,
	})
	if err != nil {
